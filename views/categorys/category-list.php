...
<div id="event-alert" class="alert-container position-fixed bottom-0 end-0 p-3 d-flex justify-content-end" style="z-index: 1050;">
    <div class="card shadow-lg border-0 rounded-3 overflow-hidden animate__animated animate__bounceInRight" 
         style="max-width: 350px; background: linear-gradient(135deg, #ffff, #ffff);">
        <div class="card-header bg-warning d-flex align-items-center p-3">
            <i class="bi bi-calendar-event fs-3 me-2 text-white animate__animated animate__pulse animate__infinite"></i>
            <h5 class="mb-0 fw-bold text-white">Upcoming Events</h5>
            <button type="button" class="btn-close btn-close-white ms-auto" onclick="closeAlert();" aria-label="Close"></button>
        </div>
        <div class="card-body p-3">
            <p class="text-muted mb-3">The following events are coming up:</p>
            <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex align-items-center p-2 animate__animated animate__fadeInUp">
                    <i class="bi bi-calendar-check text-warning me-2"></i>
                    <span class="flex-grow-1">Event 1 Title</span>
                    <span class="badge bg-warning rounded-pill">2025-03-29</span>
                </li>
                <li class="list-group-item d-flex align-items-center p-2 animate__animated animate__fadeInUp">
                    <i class="bi bi-calendar-check text-warning me-2"></i>
                    <span class="flex-grow-1">Event 2 Title</span>
                    <span class="badge bg-warning rounded-pill">2025-04-01</span>
                </li>
            </ul>
        </div>
...
<script>
    function closeAlert() {
        let alertBox = document.getElementById("event-alert");
        if (alertBox) {
