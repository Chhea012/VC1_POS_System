...
document.getElementById('exportButton').addEventListener('click', function() {
    try {
        ...
        const logoUrl = '/views/assets/modules/img/logo/logo.png'; // Path to the logo
        loadImageAsBase64(logoUrl, function(base64Image) {
            ...
            // Save the PDF
            doc.save(`mak_oun_sing_food_report_${new Date().toISOString().slice(0,10)}.pdf`);
        });
    } catch (error) {
